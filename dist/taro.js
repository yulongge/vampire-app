...
function mapNameByContion(nodeName, key, element) {
  ...
  if (mapName) {
    element.enqueueUpdate({
      path: "".concat(element._path, ".", "nn" /* NodeName */),
      value: mapName
    });
  }
}
...
var hostConfig = {
  modifyHydrateData: function modifyHydrateData(data) {
    var nodeName = data["nn" /* NodeName */];
    if (!isHtmlTags(nodeName)) return;
     true && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_2__[/* warn */ "s"])(data["nn" /* NodeName */] === 'select', '请使用 Picker 组件代替 <select>');
    // map nodeName
  ...
  modifySetAttrPayload: function modifySetAttrPayload(element, key, payload) {
    ...
    if (key === "cl" /* Class */) {
      ...
      payload.path = "".concat(_path, ".", "st" /* Style */);
...
function hydrate(node) {
  ...
  if (!node.isAnyEventBinded() && SPECIAL_NODES.indexOf(nodeName) > -1) {
    data["nn" /* NodeName */] = "static-".concat(nodeName);
  ...
  Object(_Users_mac_Documents_study_vampire_app_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(TaroNode, [{
    ...
    get: function get() {
      ...
      if (parentNode) {
        ...
        return "".concat(parentNode._path, ".", "cn" /* Childnodes */, ".").concat(index);
      }
      return '';
    }
  }, {
    ...
    set: function set(text) {
      ...
      if (text === '') {
        this.enqueueUpdate({
          path: "".concat(this._path, ".", "cn" /* Childnodes */),
...
function setStyle(newVal, styleKey) {
  ...
  if (old !== newVal) {
    ...
    this._element.enqueueUpdate({
      path: "".concat(this._element._path, ".", "st" /* Style */),
      value: this.cssText
    });
  }
}
  ...
  Object(_Users_mac_Documents_study_vampire_app_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(TaroElement, [{
    ...
    value: function setAttribute(qualifiedName, value) {
      ...
      if (isPureView && isHasExtractProp(this)) {
        this.enqueueUpdate({
          path: "".concat(this._path, ".", "nn" /* NodeName */),
          value: STATIC_VIEW
        });
      }
    }
        ...
        set: function set(html) {
          if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(impl)) {
            impl.call(ctx, ctx, html, getDoc);
             ...
             true && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* warn */ "s"])(true, '请实现 node.innerHTML');
          }
        },
        get: function get() {
          return '';
      ...
      ctx.insertAdjacentHTML = function (position, html) {
        if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(impl)) {
          impl.call(ctx, position, html, getDoc);
           ...
           true && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* warn */ "s"])(true, '请实现 node.insertAdjacentHTML');
        }
      };
    }
  }]);
      ...
      ctx.getBoundingClientRect = /*#__PURE__*/Object(_Users_mac_Documents_study_vampire_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])( /*#__PURE__*/Object(_Users_mac_Documents_study_vampire_app_node_modules_babel_runtime_helpers_esm_regeneratorRuntime__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])().mark(function _callee() {
        ...
        return Object(_Users_mac_Documents_study_vampire_app_node_modules_babel_runtime_helpers_esm_regeneratorRuntime__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 5:
               true && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* warn */ "s"])(true, '请实现 element.getBoundingClientRect');
...
__decorate([Object(inversify__WEBPACK_IMPORTED_MODULE_16__[/* inject */ "c"])(SERVICE_IDENTIFIER.modifyMpEvent), Object(inversify__WEBPACK_IMPORTED_MODULE_16__[/* optional */ "f"])(), __metadata("design:type", Array)], Hooks.prototype, "modifyMpEventImpls", void 0);
...
__decorate([Object(inversify__WEBPACK_IMPORTED_MODULE_16__[/* inject */ "c"])(SERVICE_IDENTIFIER.initNativeApi), Object(inversify__WEBPACK_IMPORTED_MODULE_16__[/* optional */ "f"])(), __metadata("design:type", Function)], Hooks.prototype, "initNativeApi", void 0);
...
var TaroEvent = /*#__PURE__*/function () {
  ...
  Object(_Users_mac_Documents_study_vampire_app_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(TaroEvent, [{
    ...
    get: function get() {
      ...
      }, (_b = this.mpEvent) === null || _b === void 0 ? void 0 : _b.target), (_c = this.mpEvent) === null || _c === void 0 ? void 0 : _c.detail);
    }
  }, {
    key: "currentTarget",
    get: function get() {
      ...
      }, (_b = this.mpEvent) === null || _b === void 0 ? void 0 : _b.currentTarget), (_c = this.mpEvent) === null || _c === void 0 ? void 0 : _c.detail);
    }
  }]);
  return TaroEvent;
}();
...
/*!********************************************************!*\
  !*** ./node_modules/@tarojs/shared/dist/shared.esm.js ***!
  \********************************************************/
/*! exports provided: EMPTY_ARR, EMPTY_OBJ, animationEvents, box, cacheDataGet, cacheDataHas, cacheDataSet, capitalize, controlledComponent, defaultReconciler, ensure, events, focusComponents, getUniqueKey, hasOwn, internalComponents, isArray, isBoolean, isBooleanStringLiteral, isFunction, isNull, isNumber, isObject, isString, isUndefined, mergeInternalComponents, mergeReconciler, nestElements, noop, processApis, queryToJson, setUniqueKeyToRoute, singleQuote, styles, toCamelCase, toDashed, toKebabCase, touchEvents, unbox, unsupport, voidElements, warn */
...
var isArray = Array.isArray;
var styles = {
  style: "i.".concat("st" /* Style */),
  class: "i.".concat("cl" /* Class */)
};
